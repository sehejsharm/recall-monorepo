...
export const gate2Questions: Question[] = [
  ...
  { id: "gate-programming-ds-searching-sorting-q03", topicId: "gate-programming-ds-searching-sorting", text: "Merge Sort has a worst-case time complexity of:", optionA: "O(n log n)", optionB: "O(n²)", optionC: "O(n)", optionD: "O(log n)", correctOption: "A", explanation: "Merge Sort always splits and merges in O(n log n) time.", orderIndex: 2 },
