...
export const gate5Questions: Question[] = [
  ...
  { id: "gate-core-cs-tcp-ip-subnetting-q05", topicId: "gate-core-cs-tcp-ip-subnetting", text: "How many usable host addresses does a /24 subnet provide?", optionA: "254", optionB: "256", optionC: "252", optionD: "128", correctOption: "A", explanation: "2^(32−24) − 2 = 256 − 2 = 254 usable hosts.", orderIndex: 4 },
  ...
  { id: "gate-core-cs-tcp-ip-subnetting-q08", topicId: "gate-core-cs-tcp-ip-subnetting", text: "Which protocol resolves an IP address to a MAC address?", optionA: "ARP", optionB: "DNS", optionC: "DHCP", optionD: "ICMP", correctOption: "A", explanation: "ARP (Address Resolution Protocol) maps IP addresses to MAC addresses.", orderIndex: 7 },
